...
class ModelManager:
    def create_model(self, models_path, iterations=1):
    ...
    def add_to_processed(self, models_path, model_id, elapsed_ms):
        solutions_file = f'{models_path}.result'
